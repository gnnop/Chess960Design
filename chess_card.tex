...
\begin{tikzpicture}[x=0.5in,y=0.5in,
  ...
  \foreach \corner in {0,1,2,3} {
    ...
    \begin{scope}[rotate around={\angle:(\cornerx,\cornery)}, shift={(\cornerx,\cornery)}]
      ...
      \foreach \startfile/\endfile in {4/6} {
        ...
        \pgfmathsetmacro{\midy}{0.7*\squaresize}
      ...
      \foreach \startfile/\endfile in {7/5} {
        \pgfmathsetmacro{\startx}{\startfile * \squaresize + \squaresize/2}
        \pgfmathsetmacro{\starty}{1*\squaresize}
        \pgfmathsetmacro{\endx}{\endfile * \squaresize + \squaresize/2}
        \pgfmathsetmacro{\endy}{1*\squaresize}
      ...
      \foreach \startfile/\endfile in {4/2, 0/3} {
        \pgfmathsetmacro{\startx}{\startfile * \squaresize + \squaresize/2}
        \pgfmathsetmacro{\starty}{1*\squaresize}
        \pgfmathsetmacro{\endx}{\endfile * \squaresize + \squaresize/2}
        \pgfmathsetmacro{\endy}{1*\squaresize}
        \pgfmathsetmacro{\midy}{0.5*\squaresize}
      ...
      \foreach \startfile/\endfile in {4/2} {
        \pgfmathsetmacro{\startx}{\startfile * \squaresize + \squaresize/2}
        \pgfmathsetmacro{\starty}{1*\squaresize}
        \pgfmathsetmacro{\endx}{\endfile * \squaresize + \squaresize/2}
        \pgfmathsetmacro{\endy}{1*\squaresize}
        \pgfmathsetmacro{\midy}{0.4*\squaresize}
